...
import android.support.v7.widget.LinearLayoutManager;  //三种布局管理器之一
...
import com.md.demo.recyclerview.adapter.MDRvAdapter;  //适配器
...
public class MDLinearRvActivity extends MDBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rv_linear);  //关联xml布局
        initData();
        initView();
        initAction();
    }
    ...
    private void initView() {
        ...
        // 设置布局管理器
        mRecyclerView.setLayoutManager(mLayoutManager); // 在initData中
        // 设置adapter
